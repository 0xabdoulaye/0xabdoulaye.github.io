...
Gem::Specification.new do |spec|
  ...
  spec.version       = "6.0.1"
  spec.authors       = ["Abdoulaye Diallo"]
  spec.email         = ["nenandjabhata@proton.me"]

  spec.summary       = "A Cybersecurity Enthusiast from Guinea"
  spec.homepage      = "https://blackcybersec.xyz"
  spec.license       = "MIT"
